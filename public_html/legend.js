...
function refresh_colored_altitude_zones() {
    document.getElementById('altitude_legend').innerHTML=getAltitudeZoneColors(NumberOfAltitudeZones);
}

function refresh_range_legend() {
    document.getElementById('range_legend').innerHTML=getRangeRingsLegend();
}
